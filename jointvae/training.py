...
from viz.visualize import DataGather
...
class Trainer():
    ...
    def _loss_function(self, data, recon_data, latent_dist):
        ...
        if self.model.training and self.num_steps % self.record_loss_every == 1:
            ...
            self.data_gether.insert(iter=self.num_steps, recon_loss=recon_loss.data,
                                    total_cont_kld=kl_cont_loss.data,
                                    total_disc_kld=kl_disc_loss.data, dim_cont_wise_kld=self.kl_dim_value.data)
